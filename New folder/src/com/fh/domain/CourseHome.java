...
public class CourseHome {
	...
	public Course merge(Course detachedInstance) {
		...
		try {
			Course result = (Course) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Course findById(java.lang.Integer id) {
		...
		try {
			Course instance = (Course) sessionFactory.getCurrentSession().get("com.fh.domain.Course", id);
			if (instance == null) {
	...
	public List findByExample(Course instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.fh.domain.Course")

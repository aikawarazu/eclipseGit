...
public class OrderitemHome {
	...
	public Orderitem merge(Orderitem detachedInstance) {
		...
		try {
			Orderitem result = (Orderitem) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Orderitem findById(java.lang.Integer id) {
		...
		try {
			Orderitem instance = (Orderitem) sessionFactory.getCurrentSession().get("com.fh.domain.Orderitem", id);
			if (instance == null) {
	...
	public List findByExample(Orderitem instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.fh.domain.Orderitem")

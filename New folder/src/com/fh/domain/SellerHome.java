...
/**
 * Home object for domain model class Seller.
 * @see com.fh.domain.Seller
 * @author Hibernate Tools
 */
public class SellerHome {

	private static final Log log = LogFactory.getLog(SellerHome.class);
	...
	public void persist(Seller transientInstance) {
		log.debug("persisting Seller instance");
		try {
	...
	public Seller merge(Seller detachedInstance) {
		...
		try {
			Seller result = (Seller) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Seller findById(java.lang.Integer id) {
		...
		try {
			Seller instance = (Seller) sessionFactory.getCurrentSession().get("com.fh.domain.Seller", id);
			if (instance == null) {
	...
	public List findByExample(Seller instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.fh.domain.Seller")

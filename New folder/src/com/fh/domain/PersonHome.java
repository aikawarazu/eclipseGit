...
public class PersonHome {
	...
	public Person findById(java.lang.Integer id) {
		...
		try {
			Person instance = (Person) sessionFactory.getCurrentSession().get("com.fh.domain.Person", id);
			if (instance == null) {
	...
	public List findByExample(Person instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.fh.domain.Person")

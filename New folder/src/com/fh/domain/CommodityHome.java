...
/**
 * Home object for domain model class Commodity.
 * @see com.fh.domain.Commodity
 * @author Hibernate Tools
 */
public class CommodityHome {

	private static final Log log = LogFactory.getLog(CommodityHome.class);
	...
	public void persist(Commodity transientInstance) {
		log.debug("persisting Commodity instance");
		try {
	...
	public Commodity merge(Commodity detachedInstance) {
		...
		try {
			Commodity result = (Commodity) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Commodity findById(java.lang.Integer id) {
		...
		try {
			Commodity instance = (Commodity) sessionFactory.getCurrentSession().get("com.fh.domain.Commodity", id);
			if (instance == null) {
	...
	public List findByExample(Commodity instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.fh.domain.Commodity")

...
public class ClassesHome {
	...
	public Classes findById(java.lang.Integer id) {
		...
		try {
			Classes instance = (Classes) sessionFactory.getCurrentSession().get("com.fh.domain.Classes", id);
			if (instance == null) {
	...
	public List findByExample(Classes instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.fh.domain.Classes")

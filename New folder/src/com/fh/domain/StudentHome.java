...
public class StudentHome {
	...
	public Student findById(java.lang.Integer id) {
		...
		try {
			Student instance = (Student) sessionFactory.getCurrentSession().get("com.fh.domain.Student", id);
			if (instance == null) {
	...
	public List findByExample(Student instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.fh.domain.Student")
